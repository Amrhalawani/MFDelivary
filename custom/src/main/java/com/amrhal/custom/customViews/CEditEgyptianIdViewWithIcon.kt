...
class CEditEgyptianIdViewWithIcon(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs), IViews {
    ...
    init {
        ...
        val view = inflater.inflate(R.layout.custom_egyptian_id_edit_view_with_icon, this, true)
        et = view.findViewById(R.id.edit_text)
        tvError = view.findViewById(R.id.text_error)

        et.hint = "xxxxxxxxxxxxxx"
...
//    }
    ...
    override fun validateActions(isValid: Boolean) {
        ...
        tvError.text = context.getString (R.string.egyptian_id_error_msg)
