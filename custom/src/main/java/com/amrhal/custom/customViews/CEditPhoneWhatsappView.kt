...
class CEditPhoneWhatsappView(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs), IViews {
    ...
    init {
        ...
        val view = inflater.inflate(R.layout.custom_whatsapp_phone_edit_view, this, true)
