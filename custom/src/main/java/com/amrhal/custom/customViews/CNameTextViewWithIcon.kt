...
class CNameTextViewWithIcon(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs),
    IViews {
    ...
    init {
        ...
        val view = inflater.inflate(R.layout.custom_name_edit_text_with_icon, this, true)
